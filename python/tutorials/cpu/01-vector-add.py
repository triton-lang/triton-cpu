...
@triton.autotune(
    configs=[
        ...
        triton.Config({'TILE_SIZE': 16, 'BLOCK_SIZE': 4096}),
        triton.Config({'TILE_SIZE': 16, 'BLOCK_SIZE': 8192}),
        triton.Config({'TILE_SIZE': 16, 'BLOCK_SIZE': 16384}),
        triton.Config({'TILE_SIZE': 16, 'BLOCK_SIZE': 32768}),
        triton.Config({'TILE_SIZE': 16, 'BLOCK_SIZE': 65536}),
    ],
    key=['n_elements'],
)
@triton.jit
