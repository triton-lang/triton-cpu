...
#loc = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0)
#map = affine_map<(d0, d1, d2) -> (d0, d2)>
#map1 = affine_map<(d0, d1, d2) -> (d2, d1)>
#map2 = affine_map<(d0, d1, d2) -> (d0, d1)>
module {
  tt.func public @matmul_blocked_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5696:0)) attributes {noinline = false} {
    ...
    %10 = tt.make_tensor_ptr %arg1, [%5, %8], [%9, %c1_i64], [%c0_i32, %3] {order = array<i32: 1, 0>} : <tensor<16x32xf32>> loc(#loc7)
    %11 = arith.divsi %arg5, %c16_i32 : i32 loc(#loc20)
    %12:3 = scf.for %arg9 = %c0_i32 to %11 step %c1_i32 iter_args(%arg10 = %cst_0, %arg11 = %7, %arg12 = %10) -> (vector<32x32xf32>, !tt.ptr<tensor<32x16xf32>>, !tt.ptr<tensor<16x32xf32>>)  : i32 {
      ...
      %20 = triton_cpu.extract_memref %arg12 : <tensor<16x32xf32>> -> memref<?x?xf32, strided<[?, 1]>> loc(#loc12)
      %21:2 = triton_cpu.extract_indices %arg12 : <tensor<16x32xf32>> -> index, index loc(#loc12)
      %22 = vector.transfer_read %20[%21#0, %21#1], %cst : memref<?x?xf32, strided<[?, 1]>>, vector<16x32xf32> loc(#loc12)
      %23 = vector.contract {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %19, %22, %arg10 : vector<32x16xf32>, vector<16x32xf32> into vector<32x32xf32> loc(#loc13)
      %24 = tt.advance %arg11, [%c0_i32, %c16_i32] : <tensor<32x16xf32>> loc(#loc14)
      %25 = tt.advance %arg12, [%c16_i32, %c0_i32] : <tensor<16x32xf32>> loc(#loc15)
      scf.yield %23, %24, %25 : vector<32x32xf32>, !tt.ptr<tensor<32x16xf32>>, !tt.ptr<tensor<16x32xf32>> loc(#loc16)
    } loc(#loc10)
    %13 = arith.extsi %arg8 : i32 to i64 loc(#loc17)
    %14 = tt.make_tensor_ptr %arg2, [%4, %8], [%13, %c1_i64], [%2, %3] {order = array<i32: 1, 0>} : <tensor<32x32xf32>> loc(#loc17)
    %15 = triton_cpu.extract_memref %14 : <tensor<32x32xf32>> -> memref<?x?xf32, strided<[?, 1]>> loc(#loc18)
    %16:2 = triton_cpu.extract_indices %14 : <tensor<32x32xf32>> -> index, index loc(#loc18)
    vector.transfer_write %12#0, %15[%16#0, %16#1] : vector<32x32xf32>, memref<?x?xf32, strided<[?, 1]>> loc(#loc18)
    tt.return loc(#loc19)
  } loc(#loc)
} loc(#loc)
#loc1 = loc(unknown)
#loc2 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5706:26)
#loc3 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5707:26)
#loc4 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5717:29)
#loc5 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5718:29)
#loc6 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5721:106)
#loc7 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5723:106)
#loc8 = loc("/home/jovyan/triton-cpu/python/triton/language/standard.py":40:28)
#loc9 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5725:36)
#loc10 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5725:51)
#loc11 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5726:20)
#loc12 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5727:20)
#loc13 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5728:32)
#loc14 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5729:44)
#loc15 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5730:44)
#loc16 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5730:8)
#loc17 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5741:36)
#loc18 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5742:26)
#loc19 = loc("/home/jovyan/triton-cpu/python/test/unit/language/test_core.py":5742:4)
